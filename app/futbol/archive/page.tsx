...
export default function FutbolArchive() {
  ...
  useEffect(() => {
    ...
    dates.forEach(d => {
      const saved = localStorage.getItem(`futbol_daily_${d}`)
      if (saved) {
        try {
      ...
      <div className="page-shell">
        <div className="page-card" style={{ width: 'min(100%, 600px)' }}>
          <div className="daily-header" style={{ marginBottom: 24 }}>
            <h1 className="daily-title" style={{ fontSize: '1.8rem' }}>Archivo — Carrera Diaria</h1>
            {/* BOTÓN VOLVER ARREGLADO A /futbol */}
